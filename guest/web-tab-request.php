    ...
    <div class="main-wrapper" id="gradbg-wb">
	    ...
	    <section class="blog-list px-3 py-5 p-md-5">
			...
			<nav class="blog-nav nav nav-justified my-5">
				  <a class="nav-link-prev nav-item nav-link rounded-left" href="#.php">Individual</a>
				  <a class="nav-link-next nav-item nav-link rounded-right" href="web-tab-request-group.php">Group<i class="arrow-next fas fa-long-arrow-alt-right"></i></a>
			</nav>
